...
class Preview extends \Magento\Backend\Block\Widget\Form\Generic
{
     ...
     * @since 100.1.0
     * @deprecated 101.1.5 Default Session ID fixation via URLmechanism is not employed anymore.
     */
     ...
     * @return string
     * @since 100.1.0
     * @deprecated 101.1.5 SID is not being passed as a URL parameter anymore.
     */
    public function getSidParamName()
    {
        return 'preview_admin_id';
    }
