...
class ControllersTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @param InvokedRecorder $expectedForwardInvoke
     * @param InvokedRecorder $getActionNameInvokeCount
     */
    protected function expectsForward(InvokedRecorder $expectedForwardInvoke, InvokedRecorder $getActionNameInvokeCount)
    {
        $this->_ctrlRequestMock->expects($expectedForwardInvoke)->method('setActionName')->with(Ctrl::ACTION_DENIED)
            ->willReturnSelf();
        $this->_ctrlRequestMock->expects($getActionNameInvokeCount)->method('getActionName')
            ->willReturn(Ctrl::ACTION_DENIED);
        $this->_ctrlRequestMock->expects($expectedForwardInvoke)->method('setDispatched')->with(false);
    }
