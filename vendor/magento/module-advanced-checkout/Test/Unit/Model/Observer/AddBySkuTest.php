...
class AddBySkuTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->cartProviderMock = $this->createPartialMock(
            \Magento\AdvancedCheckout\Model\Observer\CartProvider::class,
            [
    ...
    public function testExecute()
    {
        ...
        $storeId = 1;
        $quoteSession = $this->getMockBuilder(\Magento\Backend\Model\Session\Quote::class)
        ...
        $this->orderCreateModelMock->expects($this->any())
            ->method('getSession')
            ->will($this->returnValue($quoteSession));
